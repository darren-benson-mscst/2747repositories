<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="dbenson2747ex2d._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <div class="jumbotron">
        <h2>COMC2747 Exercise 2D: Vendor Addresses</h2>
        <p class="lead">Stored procedures, DB updates, transactions, SqlParameters, obj-relational mapping, POCO domain classes, web interface, unbound controls</p>       
    </div>
