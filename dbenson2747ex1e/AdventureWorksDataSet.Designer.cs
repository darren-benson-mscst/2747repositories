...
namespace dbenson2747ex1e.AdventureWorksDataSetTableAdapters {
...
SELECT PurchaseOrderID, PurchaseOrderDetailID, DueDate, OrderQty, ProductID, UnitPrice, LineTotal, ReceivedQty, RejectedQty, StockedQty, ModifiedDate FROM Purchasing.PurchaseOrderDetail WHERE (PurchaseOrderDetailID = @PurchaseOrderDetailID) AND (PurchaseOrderID = @PurchaseOrderID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::dbenson2747ex1e.Properties.Settings.Default.AdventureWorksConnectionString;
        }
...
SELECT PurchaseOrderID, RevisionNumber, Status, EmployeeID, VendorID, ShipMethodID, OrderDate, ShipDate, SubTotal, TaxAmt, Freight, TotalDue, ModifiedDate FROM Purchasing.PurchaseOrderHeader WHERE (PurchaseOrderID = @PurchaseOrderID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        PurchaseOrderID, RevisionNumber, Status, EmployeeID, VendorID, ShipMethodID, OrderDate, ShipDate, SubTotal, TaxAmt, Freight, TotalDue, ModifiedDate
FROM            Purchasing.PurchaseOrderHeader
WHERE        (VendorID >= 1492) AND (VendorID <= 1499)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
...
SELECT BusinessEntityID, Name FROM Purchasing.Vendor WHERE (BusinessEntityID = @BusinessEntityID) ORDER BY Name";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
