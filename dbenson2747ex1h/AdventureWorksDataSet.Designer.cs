...
namespace dbenson2747ex1h.AdventureWorksDataSetTableAdapters {
...
SELECT PurchaseOrderID, RevisionNumber, Status, EmployeeID, VendorID, ShipMethodID, OrderDate, ShipDate, SubTotal, TaxAmt, Freight, TotalDue FROM Purchasing.PurchaseOrderHeader WHERE (PurchaseOrderID = @PurchaseOrderID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::dbenson2747ex1h.Properties.Settings.Default.AdventureWorksConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "SELECT        PurchaseOrderID, RevisionNumber, Status, EmployeeID, VendorID, Ship" +
            ...
            this._commandCollection[3].CommandText = @"SELECT        PurchaseOrderID, RevisionNumber, Status, EmployeeID, VendorID, ShipMethodID, OrderDate, ShipDate, SubTotal, TaxAmt, Freight, TotalDue, ModifiedDate
FROM            Purchasing.PurchaseOrderHeader
WHERE        (VendorID = @VendorID) AND (OrderDate BETWEEN @StartDate AND @EndDate)";
            ...
            this._commandCollection[4].CommandText = "SELECT        MAX(OrderDate) AS NewestPO\r\nFROM            Purchasing.PurchaseOrde" +
                "rHeader\r\nWHERE        (VendorID = @VendorID)";
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> CountPurchaseOrdersByVendor(int VendorID) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<global::System.DateTime> GetPOEndDateByVendor(int VendorID) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<global::System.DateTime> GetPOStartDateByVendor(int VendorID) {
...
FROM            Purchasing.Vendor INNER JOIN
                         ...
                         Person.Address AS Address_1 ON Person.BusinessEntityAddress.AddressID = Address_1.AddressID INNER JOIN
                         Person.StateProvince ON Address_1.StateProvinceID = Person.StateProvince.StateProvinceID
WHERE        (Person.StateProvince.StateProvinceCode LIKE '%' + @StateProvinceCode + '%')
ORDER BY Purchasing.Vendor.Name";
            this._commandCollection[4].CommandType = global::System.Data.CommandType.Text;
